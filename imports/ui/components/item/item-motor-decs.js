...
import './item-motor-decs.html';
import './item-search.js';
import './item-motor-show.js';
import './item-motor-edit.js';


Template.Item_motor_DECS.onCreated(function() {
...
Template.Item_motor_DECS.helpers({
  // pathForLabel() {
...
Template.Item_motor_DECS.events({
